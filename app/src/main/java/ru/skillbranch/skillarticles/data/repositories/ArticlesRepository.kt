...
object ArticlesRepository {
    ...
    private fun findBookmarkArticlesByRange(start: Int, size: Int): List<ArticleItemData> {
        return local.localArticleItems
    ...
    private fun searchBookmarkArticlesByTitle(
        start: Int,
        size: Int,
        queryTitle: String
    ): List<ArticleItemData> {
...
class ArticleDataSource(private val strategy: ArticleStrategy) :
    ...
    override fun loadRange(params: LoadRangeParams, callback: LoadRangeCallback<ArticleItemData>) {
        ...
        Log.d(
            "ArticlesRepository",
            "loadRange: start ${params.startPosition}, " +
